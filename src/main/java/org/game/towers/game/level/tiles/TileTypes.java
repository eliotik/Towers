...
public class TileTypes {
	...
	private Tile getTileExit(Level level, int x, int y, boolean staticSprite) {
		return new AnimatedTile(level,
				...
				Config.TILE_EXIT, 0xffff0000, false, false, x, y, 170, 0, true, 80, false);
	}
	...
	private Tile getTileEntrance(Level level, int x, int y, boolean staticSprite) {
		return new AnimatedTile(level,
				...
				Config.TILE_ENTRANCE, 0xfffaa71a, false, false, x, y, 170, 0, false, 0, false);
	}
	...
	private Tile getTileBush(Level level, int x, int y, boolean staticSprite) {
		...
		return new BasicTile(level, SpritesData.BUSH, Config.TILE_BUSH, 0xff69bd45, true, false, x, y, mirrorMask, 60, false, 0, false);
	}
	...
	private Tile getTileStone(Level level, int x, int y, boolean staticSprite) {
		...
		return new BasicTile(level, SpritesData.STONE, Config.TILE_STONE, 0xff555555, true, false, x, y, mirrorMask, 80, false, 0, false);
	}
	...
	private Tile getTileIce(Level level, int x, int y, boolean staticSprite) {
		...
		return new BasicTile(level, SpritesData.ICE, Config.TILE_ICE, 0xff51b1e6, true, false, x, y, mirrorMask, 40, false, 0, false);
	}
